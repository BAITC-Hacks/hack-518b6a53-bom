...
Новое значение показателя. Для каждого района d и показателя k: I'_dk = clip(I_dk + Σ эффект_m,k × (8 − L_m)/8 + синергии, 0, 100)
Оценка района. D_d = Σ w_k × I'_dk. Веса показателей:
Показатель
T1
T2
E1
